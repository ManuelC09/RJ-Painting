...
export default function FinalCTA() {
  return (
    <section className="relative overflow-hidden bg-[#F8F5F0] px-6 py-24">
        ...
        >
          ...
          <div className="relative mx-auto max-w-4xl">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-white/75">
              Whether you’re planning an interior repaint, exterior
              transformation, deck restoration, or finishing project, RJ Painting
              is ready to help.
            </p>
