...
const translations = {
  en: {
    eyebrow: "Ready To Restore Your Deck?",

    title:
      "Refresh Outdoor Wood Surfaces With Professional Deck Finishing",

    description:
      "RJ Painting provides deck staining and painting services designed to improve appearance, durability, and long-term outdoor protection.",
  ...
  fr: {
    eyebrow: "Prêt à restaurer votre terrasse?",

    title:
      "Rafraîchissez vos surfaces extérieures en bois avec une finition professionnelle",

    description:
      "RJ Painting offre des services de teinture et de peinture de terrasses conçus pour améliorer l’apparence, la durabilité et la protection à long terme de vos surfaces extérieures.",
