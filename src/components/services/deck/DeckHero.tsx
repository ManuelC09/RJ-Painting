...
import { ArrowRight, CheckCircle, Trees } from "lucide-react";
    ...
    <section className="relative min-h-[88vh] overflow-hidden bg-[#152536]">
      ...
      <div className="relative z-10 mx-auto flex min-h-[88vh] max-w-7xl items-center px-6 pb-16 pt-48 lg:pt-44">
        <div className="max-w-4xl">
          ...
          >
            Professional deck staining and painting services designed to refresh
            weathered wood, improve outdoor living spaces, and protect surfaces
            from long-term wear.
          </motion.p>
          ...
          >
            {["Deck Staining", "Deck Painting", "Fence Finishing", "Wood Prep"].map(
              (item) => (
                <div
                  key={item}
