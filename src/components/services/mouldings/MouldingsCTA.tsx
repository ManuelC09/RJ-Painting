...
const translations = {
  en: {
    eyebrow: "Ready To Refresh Your Interior Finishes?",

    title:
      "Elevate Your Home With Professional Trim & Moulding Finishing",

    description:
      "RJ Painting provides professional trim and moulding painting services throughout Montreal’s West Island.",
  ...
  fr: {
    eyebrow: "Prêt à rafraîchir vos finitions intérieures?",

    title:
      "Mettez votre maison en valeur grâce à une finition professionnelle des moulures et boiseries",

    description:
      "RJ Painting offre des services professionnels de peinture de moulures et de boiseries partout dans l’Ouest-de-l’Île de Montréal.",
