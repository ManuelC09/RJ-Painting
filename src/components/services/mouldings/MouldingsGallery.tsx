        ...
        <motion.div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            ...
            <p className="mt-6 text-lg leading-8 text-[#152536]/70">
              Explore baseboards, crown mouldings, window trim, door frames, and
              detailed finishing work.
            </p>
          </div>

          <Link href="/gallery" className="inline-flex items-center gap-3 self-start rounded-md bg-[#8B2E35] px-7 py-4 text-sm font-bold text-white transition hover:bg-[#263E5A]">
            View Full Gallery
            <ArrowRight size={18} />
          </Link>
        </motion.div>
