...
import { Clock, ShieldCheck, Sparkles, Sun } from "lucide-react";
        ...
        <div className="grid gap-14 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-8 text-white/70">
              Deck cleaning and protection helps preserve the appearance of your
              outdoor space while preparing the surface for stronger,
