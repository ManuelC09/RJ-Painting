    ...
    <section className="relative min-h-[88vh] overflow-hidden bg-[#152536]">
      ...
      <div className="relative z-10 mx-auto flex min-h-[88vh] max-w-7xl items-center px-6 pb-16 pt-48 lg:pt-44">
        <div className="max-w-4xl">
          ...
          >
            Clean, Restore & Protect Your{" "}
            <span className="text-[#D35B66]">Outdoor Deck</span>
          </motion.h1>
          ...
          >
            Professional deck cleaning and protection services designed to
            remove buildup, refresh outdoor wood surfaces, and help protect your
            deck from weather, moisture, and seasonal wear.
          </motion.p>
