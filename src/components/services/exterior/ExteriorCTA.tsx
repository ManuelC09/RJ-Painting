...
const translations = {
  en: {
    eyebrow: "Ready To Transform Your Exterior?",

    title:
      "Improve Curb Appeal & Protect Your Home With Professional Exterior Painting",

    description:
      "RJ Painting provides durable exterior painting services designed to modernize your home, protect exterior surfaces, and create a cleaner, more polished appearance.",
  ...
  fr: {
    eyebrow: "Prêt à transformer l’extérieur de votre maison?",

    title:
      "Améliorez l’apparence extérieure et protégez votre maison grâce à une peinture professionnelle",

    description:
      "RJ Painting offre des services durables de peinture extérieure conçus pour moderniser votre maison, protéger les surfaces extérieures et créer une apparence plus propre et soignée.",
