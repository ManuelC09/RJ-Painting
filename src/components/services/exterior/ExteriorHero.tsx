...
const translations = {
  en: {
    badge: "Exterior Painting Services",

    titleBefore: "Protect & Transform Your",
    titleHighlight: "Home’s Exterior",

    description:
      "Professional exterior residential painting designed to improve curb appeal, modernize your home, and protect exterior surfaces from weather and long-term wear.",
  ...
  fr: {
    badge: "Services de peinture extérieure",

    titleBefore: "Protégez et transformez",
    titleHighlight: "l’extérieur de votre maison",

    description:
      "Des services professionnels de peinture résidentielle extérieure conçus pour améliorer l’apparence de votre propriété, moderniser votre maison et protéger les surfaces extérieures contre les intempéries et l’usure à long terme.",
  ...
  return (
    <section className="relative min-h-[88vh] overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute inset-0 bg-[url('/images/exterior-hero.png')] bg-cover bg-center"
      />
