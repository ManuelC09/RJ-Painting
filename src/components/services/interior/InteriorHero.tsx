...
import { ArrowRight, CheckCircle, PaintRoller } from "lucide-react";
  ...
  return (
    <section className="relative min-h-[88vh] overflow-hidden bg-[#152536]">
      <motion.div
        ...
        className="absolute inset-0 bg-[url('/images/interior-hero.png')] bg-cover bg-center"
      />
      ...
      <div className="relative z-10 mx-auto flex min-h-[88vh] max-w-7xl items-center px-6 pb-16 pt-48 lg:pt-44">
        <div className="max-w-4xl">
          ...
          >
            Transform your home with clean, modern, professionally finished
            interior painting designed to elevate the appearance and comfort of
            your living spaces.
          </motion.p>
          ...
          >
            {["Living Rooms", "Kitchens", "Bedrooms", "Full-Home Repaints"].map(
              (item) => (
                <div
                  key={item}
