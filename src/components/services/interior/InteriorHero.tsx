...
const translations = {
  en: {
    badge: "Interior Painting Services",

    titleBefore: "Premium Interior Painting For",
    titleHighlight: "Beautiful Residential Spaces",

    description:
      "Transform your home with clean, modern, professionally finished interior painting designed to elevate the appearance and comfort of your living spaces.",

    estimateButton: "Request a Free Estimate",
    galleryButton: "View Interior Projects",
  ...
  fr: {
    badge: "Services de peinture intérieure",

    titleBefore: "Peinture intérieure haut de gamme pour",
    titleHighlight: "de magnifiques espaces résidentiels",

    description:
      "Transformez votre maison avec une peinture intérieure propre, moderne et réalisée professionnellement, conçue pour améliorer l’apparence et le confort de vos espaces de vie.",

    estimateButton: "Demander une estimation gratuite",
    galleryButton: "Voir les projets intérieurs",
  ...
  return (
    <section className="relative min-h-[88vh] overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute inset-0 bg-[url('/images/interior-gallery-2.png')] bg-cover bg-center"
      />
