...
const translations = {
  en: {
    badge: "Recent Interior Transformations",

    title:
      "Interior Spaces Designed To Feel New Again",

    description:
      "Explore recent interior painting projects focused on clean finishes, modern colors, and professional residential detail.",
  ...
  fr: {
    badge: "Transformations intérieures récentes",

    title:
      "Des espaces intérieurs qui retrouvent une apparence neuve",

    description:
      "Découvrez nos récents projets de peinture intérieure axés sur des finis propres, des couleurs modernes et un travail résidentiel professionnel et soigné.",

    galleryButton: "Voir toute la galerie",

    items: {
      livingRoom: {
        title: "Rafraîchissement moderne du salon",
        category: "Salon",
      },

      kitchen: {
        title: "Nouvelle peinture lumineuse pour la cuisine",
        category: "Cuisine",
      },

      staircase: {
        title: "Transformation d’un escalier résidentiel",
        category: "Escalier",
      },

      bedroom: {
        title: "Finition soignée d’une chambre",
        category: "Chambre",
      },
    },
  },
