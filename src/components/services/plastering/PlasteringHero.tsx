...
const translations = {
  en: {
    badge: "Plastering & Surface Repairs",
    ...
    description:
      "RJ Painting provides plastering, wall patching, crack repair, and surface preparation services designed to restore damaged surfaces before painting begins.",
  ...
  fr: {
    ...
    titleBefore:
      "Des surfaces lisses et bien préparées pour",

    titleHighlight:
      "des résultats de peinture professionnels",

    description:
      "RJ Painting offre des services de plâtrage, de réparation de murs, de fissures et de préparation des surfaces afin de restaurer les surfaces endommagées avant le début des travaux de peinture.",
