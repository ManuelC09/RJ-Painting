        ...
        >
          ...
          <div className="relative mx-auto max-w-4xl">
            <p className="text-sm font-bold uppercase tracking-[0.25em] text-[#D35B66]">
              Ready To Modernize Your Exterior?
            </p>

            <h2 className="mt-6 text-4xl font-extrabold leading-tight tracking-tight text-white sm:text-5xl lg:text-6xl">
              Transform Brick & Stucco Surfaces With Professional Exterior
              Painting
            </h2>

            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-white/75">
              RJ Painting provides exterior brick and stucco painting services
              throughout Montreal’s West Island to help homeowners refresh,
              protect, and modernize their properties.
            </p>
