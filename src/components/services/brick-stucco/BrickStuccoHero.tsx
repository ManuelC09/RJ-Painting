      ...
      <div className="relative z-10 mx-auto flex min-h-[88vh] max-w-7xl items-center px-6 pb-16 pt-48 lg:pt-44">
        <div className="max-w-4xl">
          ...
          >
            ...
            <span className="text-[#D35B66]">Brick & Stucco Painting</span>
          </motion.h1>
          ...
          >
            Professional exterior brick and stucco painting services designed to
            refresh outdated surfaces, improve curb appeal, and protect your
